...
public final class FragmentTodoBinding implements ViewBinding {
  ...
  private FragmentTodoBinding(@NonNull FrameLayout rootView, @NonNull ImageView imageView,
  ...
  public static FragmentTodoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTodoBinding((FrameLayout) rootView, imageView, textView);
    }
